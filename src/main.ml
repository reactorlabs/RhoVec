...
let tests_pos = [
  ...
  (43, Combine [int_exp 5; (Combine [int_exp 6; int_exp 7;
                                    (Combine [na_exp T_Int]); int_exp 9])],
       vec_of_intoptlist [Some 5; Some 6; Some 7; None; Some 9]);
  (44, Combine [true_exp; (Combine [true_exp; false_exp;
                                    (Combine [na_exp T_Bool]); true_exp])],
       vec_of_booloptlist [Some true; Some true; Some false; None; Some true]);

  (* subset1 nothing with NA *)
  (45, Subset1_Nothing (Combine [int_exp 3; int_exp 1; na_exp T_Int]),
       vec_of_intoptlist [Some 3; Some 1; None]);
  (46, Subset1_Nothing (Combine [true_exp; true_exp; na_exp T_Bool]),
       vec_of_booloptlist [Some true; Some true; None]);

  (* subset2 with NA *)
  (47, Subset2 (Combine [na_exp T_Int; int_exp 2; int_exp 3], int_exp 1),
       vec_of_lit (na_lit T_Int));
  (48, Subset2 (Combine [na_exp T_Bool; true_exp; false_exp], int_exp 1),
       vec_of_lit (na_lit T_Bool));

  (* subset1 zero with NA *)
  (49, Subset1 (Combine [na_exp T_Bool; na_exp T_Bool; na_exp T_Bool],
                Combine [int_exp 0]),
       empty_vec T_Bool);
  (50, Subset1 (Combine [na_exp T_Int; na_exp T_Int; na_exp T_Int],
                Combine [int_exp 0]),
       empty_vec T_Int);
  ...
  (81, Subset1_Assign (Combine [int_exp 1; int_exp 2; int_exp 3; int_exp 4;
                                int_exp 5],
                       Combine [true_exp],
                       Combine [int_exp 0]),
       vec_of_intlist [0; 0; 0; 0; 0]);
  (82, Subset1 (Combine [int_exp 1; int_exp 2; int_exp 3; int_exp 4; int_exp 5],
                Combine [false_exp]),
       empty_vec T_Int);
  (83, Subset1_Assign (Combine [int_exp 1; int_exp 2; int_exp 3; int_exp 4;
                                int_exp 5],
                       Combine [true_exp; false_exp; true_exp],
                       Combine [int_exp 0]),
       vec_of_intlist [0; 2; 0; 0; 5]);
  (85, Subset1_Assign (Combine [int_exp 1; int_exp 2; int_exp 3; int_exp 4;
                                int_exp 5],
                       Combine [true_exp; true_exp; true_exp; true_exp;
                                true_exp],
                       Combine [int_exp 0]),
       vec_of_intlist [0; 0; 0; 0; 0]);
  (86, Subset1_Assign (Combine [int_exp 1; int_exp 2; int_exp 3; int_exp 4;
                                int_exp 5; int_exp 6],
                       Combine [true_exp],
                       Combine [int_exp 10; int_exp 11]),
       vec_of_intlist [10; 11; 10; 11; 10; 11]);
  (87, Subset1_Assign (Combine [int_exp 1; int_exp 2; int_exp 3; int_exp 4;
                                int_exp 5; int_exp 6],
                       Combine [true_exp; false_exp],
                       Combine [int_exp 10; int_exp 11; int_exp 12]),
       vec_of_intlist [10; 2; 11; 4; 12; 6]);
  (88, Subset1_Assign (Combine [int_exp 1; int_exp 2; int_exp 3],
                       Combine [true_exp; true_exp; false_exp],
                       Combine [int_exp 9; int_exp 8]),
       vec_of_intlist [9; 8; 3]);
  (89, Subset1_Assign (Combine [int_exp 1; int_exp 2; int_exp 3],
                       Combine [true_exp; true_exp; true_exp; true_exp;
                                false_exp],
                       Combine [int_exp 9; int_exp 8]),
  ...
  (97, Negate (Combine [int_exp 1; int_exp ~-2; int_exp ~-3; int_exp 4]),
       vec_of_intlist [~-1; 2; 3; ~-4]);
  (98, Negate (Combine [int_exp 1; int_exp ~-2; na_exp T_Int; int_exp 4]),
       vec_of_intoptlist [Some ~-1; Some 2; None; Some ~-4]);

  (* subset1 assign negative *)
  (99, Subset1_Assign (Combine [int_exp 1; int_exp 2; int_exp 3; int_exp 4;
                                int_exp 5],
                       Negate (int_exp 1),
                       int_exp 0),
       vec_of_intlist [1; 0; 0; 0; 0]);
  (100, Subset1_Assign (Combine [int_exp 1; int_exp 2; int_exp 3; int_exp 4;
                                 int_exp 5],
                        Negate (int_exp 1),
                        Combine [int_exp 10; int_exp 11]),
        vec_of_intlist [1; 10; 11; 10; 11]);
  (101, Subset1_Assign (Combine [int_exp 1; int_exp 2; int_exp 3; int_exp 4;
                                 int_exp 5],
                        int_exp ~-1,
                        Combine [int_exp 10; int_exp 11; int_exp 12; int_exp 13]),
        vec_of_intlist [1; 10; 11; 12; 13]);
  (102, Subset1_Assign (Combine [int_exp 1; int_exp 2; int_exp 3; int_exp 4;
                                 int_exp 5],
                        Negate (Combine [int_exp 1; int_exp 3]),
                        Combine [int_exp 0]),
        vec_of_intlist [1; 0; 3; 0; 0]);
  (103, Subset1_Assign (Combine [int_exp 1; int_exp 2; int_exp 3; int_exp 4;
                                 int_exp 5],
                        Negate (Combine [int_exp 1; int_exp 3]),
                        Combine [int_exp 10; int_exp 11; int_exp 12]),
        vec_of_intlist [1; 10; 3; 11; 12]);
  (104, Subset1_Assign (Combine [int_exp 1; int_exp 2; int_exp 3; int_exp 4;
                                 int_exp 5],
                        Negate (Combine [int_exp 1; int_exp 0; int_exp 3;
                                         int_exp 10]),
                        Combine [int_exp 0]),
        vec_of_intlist [1; 0; 3; 0; 0]);
  (105, Subset1_Assign (Combine [int_exp 1; int_exp 2; int_exp 3; int_exp 4;
                                 int_exp 5],
                        Negate (Combine [int_exp 1; int_exp 0; int_exp 3;
                                         int_exp 10]),
                        Combine [int_exp 10; int_exp 11; int_exp 12]),
        vec_of_intlist [1; 10; 3; 11; 12]);
  (106, Subset1_Assign (Combine [int_exp 1; int_exp 2; int_exp 3; int_exp 4;
                                 int_exp 5],
                        Negate (Combine [int_exp 1; int_exp 3; int_exp 1]),
                        Combine [int_exp 0]),
        vec_of_intlist [1; 0; 3; 0; 0]);
  (107, Subset1_Assign (Combine [int_exp 1; int_exp 2; int_exp 3; int_exp 4;
                                 int_exp 5],
                        Negate (Combine [int_exp 1; int_exp 3; int_exp 1]),
                        Combine [int_exp 10; int_exp 11; int_exp 12]),
        vec_of_intlist [1; 10; 3; 11; 12]);
...
let tests_neg = [
  ...
  (1015, Subset2 (Subset1 (int_exp 1, int_exp 0), na_exp T_Int),
         Eval.Subscript_out_of_bounds);
  (1016, Subset2 (Subset1 (int_exp 1, int_exp 0), na_exp T_Bool),
         Eval.type_error T_Int T_Bool);
  (1017, Subset2 (Subset1 (int_exp 1, int_exp 0), Combine [na_exp T_Int]),
         Eval.Subscript_out_of_bounds);
  ...
  (* subset1 bool assign *)
  (1036, Subset1_Assign (Combine [int_exp 1; int_exp 2; int_exp 3; int_exp 4;
                                  int_exp 5],
                         Combine [true_exp],
                         Combine [int_exp 10; int_exp 11]),
         Eval.Replacement_length_not_multiple);
  (1037, Subset1_Assign (Combine [int_exp 1; int_exp 2; int_exp 3; int_exp 4;
                                  int_exp 5; int_exp 6],
                         Combine [true_exp; false_exp],
                         Combine [int_exp 10; int_exp 11]),
         Eval.Replacement_length_not_multiple);
  (1038, Subset1_Assign (Combine [int_exp 1; int_exp 2; int_exp 3; int_exp 4;
                                  int_exp 5],
                         Combine [true_exp; na_exp T_Bool],
                         Combine [int_exp 10; int_exp 11; int_exp 12]),
         Eval.No_NAs_in_subscripted_assignment);
  (1039, Subset1_Assign (Combine [int_exp 1; int_exp 2; int_exp 3; int_exp 4;
                                  int_exp 5; int_exp 6],
                         Combine [true_exp; false_exp; false_exp],
                         Combine [int_exp 10; int_exp 11; int_exp 12]),
         Eval.Replacement_length_not_multiple);
  (1040, Subset1_Assign (Combine [int_exp 1; int_exp 2; int_exp 3],
                         Combine [true_exp; true_exp; false_exp],
                         Combine [int_exp 10; int_exp 11; int_exp 12]),
         Eval.Replacement_length_not_multiple);
  ...
  (1042, Subset1_Assign (Combine [int_exp 1; int_exp 2; int_exp 3; int_exp 4],
                         ...
                         Combine [int_exp 1; int_exp 2]),
         Eval.No_NAs_in_subscripted_assignment);
  (1043, Subset1_Assign (Combine [int_exp 1; int_exp 2; int_exp 3; int_exp 4],
                         Combine [int_exp 1; na_exp T_Int],
                         Combine [int_exp 1; int_exp 2]),
         Eval.No_NAs_in_subscripted_assignment);
  (1044, Subset1_Assign (Combine [int_exp 1; int_exp 2; int_exp 3; int_exp 4;
                                  int_exp 5],
                         Combine [true_exp; false_exp; na_exp T_Bool],
                         Combine [int_exp 0]),
         Eval.No_NAs_in_subscripted_assignment);
  (1045, Subset1_Assign (Combine [int_exp 1; int_exp 2; int_exp 3; int_exp 4],
                         Combine [na_exp T_Int],
                         Combine [int_exp 1]),
         Eval.No_NAs_in_subscripted_assignment);
  (1046, Subset1_Assign (Combine [int_exp 1; int_exp 2; int_exp 3; int_exp 4],
                         Combine [int_exp 1; int_exp 4; na_exp T_Int],
                         Combine [int_exp 0]),
         Eval.No_NAs_in_subscripted_assignment);

  (* subset1 assign negative *)
  (1047, Subset1_Assign (Combine [int_exp 1; int_exp 2; int_exp 3; int_exp 4;
                                  int_exp 5],
                         Negate (int_exp 1),
                         Combine [int_exp 10; int_exp 11; int_exp 12]),
         Eval.Replacement_length_not_multiple);
  (1048, Subset1_Assign (Combine [int_exp 1; int_exp 2; int_exp 3; int_exp 4;
                                  int_exp 5],
                         Negate (Combine [int_exp 1; int_exp 3]),
                         Combine [int_exp 10; int_exp 11]),
         Eval.Replacement_length_not_multiple);
  (1049, Subset1_Assign (Combine [int_exp 1; int_exp 2; int_exp 3; int_exp 4;
                                  int_exp 5],
                         Negate (Combine [int_exp 1; int_exp 3]),
                         Combine [int_exp 10; int_exp 11; int_exp 12;
                                  int_exp 13]),
         Eval.Replacement_length_not_multiple);
  (1050, Subset1_Assign (Combine [int_exp 1; int_exp 2; int_exp 3; int_exp 4;
                                  int_exp 5],
                         Negate (Combine [int_exp 1; int_exp 0; int_exp 3;
                                          int_exp 10]),
                         Combine [int_exp 10; int_exp 11]),
         Eval.Replacement_length_not_multiple);
  (1051, Subset1_Assign (Combine [int_exp 1; int_exp 2; int_exp 3; int_exp 4;
                                  int_exp 5],
                         Negate (Combine [int_exp 1; int_exp 0; int_exp 3;
                                          int_exp 10]),
                         Combine [int_exp 10; int_exp 11; int_exp 12;
                                  int_exp 13]),
         Eval.Replacement_length_not_multiple);
  (1052, Subset1_Assign (Combine [int_exp 1; int_exp 2; int_exp 3; int_exp 4;
                                  int_exp 5],
                         Negate (Combine [int_exp 1; int_exp 0; int_exp 3;
                                          int_exp 10]),
                         Combine [int_exp 10; int_exp 11; int_exp 12;
                                  int_exp 13]),
         Eval.Replacement_length_not_multiple);
  (1053, Subset1_Assign (Combine [int_exp 1; int_exp 2; int_exp 3; int_exp 4;
                                  int_exp 5],
                         Negate (Combine [int_exp 1; int_exp 3; int_exp 1]),
                         Combine [int_exp 10; int_exp 11]),
         Eval.Replacement_length_not_multiple);
  (1054, Subset1_Assign (Combine [int_exp 1; int_exp 2; int_exp 3; int_exp 4;
                                  int_exp 5],
                         Negate (Combine [int_exp 1; int_exp 3; int_exp 1]),
                         Combine [int_exp 10; int_exp 11; int_exp 12;
                                  int_exp 13]),
         Eval.Replacement_length_not_multiple);
  (1055, Subset1_Assign (Combine [int_exp 1; int_exp 2; int_exp 3; int_exp 4;
                                  int_exp 5],
                         Negate (Combine [int_exp 1; na_exp T_Int]),
                                  int_exp 13),
         Eval.Mixing_with_neg_subscripts);
